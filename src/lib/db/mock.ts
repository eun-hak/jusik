...
import article19 from "./article-19.json";
import article20 from "./article-20.json";
import article21 from "./article-21.json";
import article22 from "./article-22.json";
import article23 from "./article-23.json";
import article24 from "./article-24.json";
import article25 from "./article-25.json";
import article26 from "./article-26.json";
import article27 from "./article-27.json";
import article28 from "./article-28.json";
...
const seed: Article[] = [
  ...
  article19 as Article,
  article20 as Article,
  article21 as Article,
  article22 as Article,
  article23 as Article,
  article24 as Article,
  article25 as Article,
  article26 as Article,
  article27 as Article,
  article28 as Article,
];
